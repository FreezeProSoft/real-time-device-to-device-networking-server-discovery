...
namespace NetworkCommunication.Core
{
    ...
    public class SocketServer
    {
        ...
        private void Listening()
        {
            ...
            {  
                ...
                while (state == SocketServerState.Running)
                {
                    ...
                    var host = new RemoteHost(socket, ((IPEndPoint)socket.RemoteEndPoint).Address.ToString());
            ...
            finally
            {
                ...
                for (int index = 0; index < hosts.Count; index++)
                {
                    ...
                    if (host.Connection != null && host.Connection.Connected)
                    {
        ...
        /// <summary>
        /// Start listening the host connection.
        /// </summary>
        ...
        /// <summary>
        /// Raises the server accept host connection event.
        /// </summary>
        /// <param name="host">Information about host connection.</param>
